Name:           ros-kinetic-web-video-server
Version:        0.0.7
Release:        0%{?dist}
...
Requires:       ros-kinetic-async-web-server-cpp
Requires:       ros-kinetic-cv-bridge
Requires:       ros-kinetic-image-transport
Requires:       ros-kinetic-roscpp
Requires:       ros-kinetic-roslib
BuildRequires:  ffmpeg-devel
BuildRequires:  ros-kinetic-async-web-server-cpp
...
%changelog
* Mon Nov 20 2017 Russell Toris <rctoris@wpi.edu> - 0.0.7-0
